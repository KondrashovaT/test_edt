...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	РегистрыСведений.ОсновныеБанковскиеСчетаКонтрагентов.ЗаписатьОсновнойБанковскийСчет(ТекущийОбъект.Ссылка, ОсновнойСчет);
...
Процедура УстановитьОсновнойБанковскийСчетКонтрагента()
	...
	ОсновнойСчет = (Объект.Ссылка = Справочники.БанковскиеСчетаКонтрагентов.ОсновнойБанковскийСчетКонтрагента(Объект.Владелец)); 
