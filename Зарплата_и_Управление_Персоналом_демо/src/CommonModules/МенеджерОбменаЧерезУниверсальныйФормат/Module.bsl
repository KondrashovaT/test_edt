////////////////////////////////////////////////////////////////////////////////
// Менеджер обмена через универсальный формат (ЗУП (1.20) от 16.02.2026 12:48:51)
//
////////////////////////////////////////////////////////////////////////////////
...
Функция Подключаемый_ИдентификаторМодуля() Экспорт
	Возврат "527b5a6e-a396-4481-b38c-49fd7b77b4f0";
КонецФункции
#Область ПОД
...
Процедура ВидыЗанятостиСотрудников_ПриОтправкеДанных(ДанныеИБ, ДанныеXDTO, КомпонентыОбмена, СтекВыгрузки)
	...
	ДанныеXDTO.КлючевыеСвойства.Вставить("Номер", РеквизитыРегистратора.Номер);
	ДанныеXDTO.КлючевыеСвойства.Вставить("Дата", РеквизитыРегистратора.Дата);
