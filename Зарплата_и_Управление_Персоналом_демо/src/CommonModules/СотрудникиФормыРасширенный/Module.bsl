...
Процедура СотрудникиПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("УчитыватьМатериальнуюОтветственностьСотрудников") 
		...
		МатериальноОтветственныеЛица.СоздатьКомандуМатериальнаяОтветственностьВФормеСотрудника(Форма, "ГруппаДополнительныеДанные2");
	КонецЕсли;
