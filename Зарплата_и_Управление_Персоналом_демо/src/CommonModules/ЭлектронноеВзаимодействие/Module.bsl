...
Процедура ПриОпределенииСправочниковХраненияФайлов(ТипВладелецФайла, ИменаСправочников) Экспорт
	...
	// ОбменСКонтрагентами
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСКонтрагентами") Тогда
		Если Метаданные.ОпределяемыеТипы["ВладелецФайлаВизуализацииЭДО"].Тип.СодержитТип(ТипВладелецФайла)
			И Не ЗначениеЗаполнено(ИменаСправочников) Тогда
			ИменаСправочников.Вставить("КэшВизуализацииДокументовЭДОПрисоединенныеФайлы", Истина);
		КонецЕсли;
	КонецЕсли;
