...
Процедура СервисыДоставкиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.СервисыДоставкиСервисДоставки Тогда
		...
		ПараметрыФормы.Вставить("ТипГрузоперевозки", ТекущиеДанные.ТипГрузоперевозки);
		ПараметрыФормы.Вставить("ОрганизацияБизнесСети",
			МодульСервисДоставкиВызовСервера.ОрганизацияПоУмолчанию(ТекущиеДанные.ТипГрузоперевозки));
		
		Форма = "Обработка.СервисДоставки.Форма.ДоступныеПеревозчики";
		ОткрытьФорму(Форма,
			ПараметрыФормы,
			ЭтотОбъект,
			ТекущиеДанные.ТипГрузоперевозки,,,,
	...
	ИначеЕсли Поле = Элементы.СервисыДоставкиПодсказка Тогда
		...
		ПараметрыФормы = Новый Структура();
		ПараметрыФормы.Вставить("ТипГрузоперевозки", ТекущиеДанные.ТипГрузоперевозки);
		ПараметрыФормы.Вставить("ОрганизацияБизнесСетиСсылка",
			МодульСервисДоставкиВызовСервера.ОрганизацияПоУмолчанию(ТекущиеДанные.ТипГрузоперевозки));
		
		Форма = "Обработка.СервисДоставки.Форма.КарточкаГрузоперевозчика";
		ОткрытьФорму(Форма,
			ПараметрыФормы,,
			ТекущиеДанные.ТипГрузоперевозки,,,,
			РежимОткрытияОкнаФормы.Независимый);
...
&НаСервере
Процедура ИзменитьИспользованиеЗаданияСинхронизацияССервисомИнтеграции()
